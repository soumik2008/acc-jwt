    ...
    try:
        ...
        with Progress(
            ...
            for uid, password in uid_password_pairs:
                    ...
                    if response.status_code == 200:
                        try:
                            ...
                            if "token" in response_data:
                                tokens.append({"token": response_data["token"]})  # ✅ Only token save karega
                ...
                progress.update(task, advance=1)  # ✅ Now updates with API requests!
